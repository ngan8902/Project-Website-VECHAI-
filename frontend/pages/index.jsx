    ...
    <div className={styles.home}>
      <div className={styles.gt}>
        ...
        <div className={styles.content}>
          ...
          <p>Website dành cho hoạt động mua bán ve chai diễn ra tiện lợi hơn <br /> với công nghệ hỗ trợ tìm kiếm người mua và người bán.</p>
          <button style={{ marginLeft: '0px' }}>Dùng Thử</button>
          <p style={{ cursor: 'pointer' }}>hoặc đăng nhập <BsChevronRight className={styles.icright} /></p>
        </div>
      </div>

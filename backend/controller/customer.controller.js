    ...
    static signUp = async (req, res, next) => {
        try {
            ...
            if(results){
                ...
                sendMail({
                    to: email,
                    subject: 'Tạo tài khoản thành công, yêu cầu xác thực tài khoản',
                    text: 'Xác thực tài khoản',
                    html:`<label>Bạn vừa tạo tài khoản thành công</label> 
                    <br>Vui lòng click bên dưới kích hoạt tài khoản</br> 
                    <a href="localhost:3000">Click vào đây</a>`
                })
            }
